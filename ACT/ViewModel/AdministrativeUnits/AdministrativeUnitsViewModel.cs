...
{
    public class AdministrativeUnitsViewModel : BaseLevelViewModel
    {
        public AdministrativeUnitsViewModel()
        {
            children = new List<AdministrativeUnitsViewModel>();
        }
        ...
        public List<AdministrativeUnitsViewModel> children { get; set; }
