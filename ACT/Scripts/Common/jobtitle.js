...
function FillJobTitle() {
    ...
    $.ajax({
        ...
        success: function (data) {
            EmptyingJobTitle();
            $.each(data, function (i, data) {
                $("#JobTitleId").append('<option value="' + data.id + '">' + data.text + '</option>');
            });
            //selected value if variable exsist
            if (typeof SelectedJobTitleId != 'undefined') {
                $('#JobTitleId').val(SelectedJobTitleId).trigger('change');
            }
        }
    });
}
...
function EmptyingJobTitle() {
    $("#JobTitleId").empty();
    $("#JobTitleId").append('<option value="">' + dropDownnPleaseSelect + '</option>');
    $('#JobTitleId').val('').trigger('change');
}
...
$('#UserCategoryId').on("change", function (e) {
    FillJobTitle();
});